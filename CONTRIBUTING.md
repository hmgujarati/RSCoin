Contributing to RSCoin Core
==================================

The RSCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the RSCoin Core project, and is not to be
confused with overall RSCoin Network Protocol consensus changes.

Whether a pull request is merged into RSCoin Core rests with the project merge
...
Patches that change RSCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the RSCoin consensus, it must have been
...
The project leader is the release manager for each RSCoin Core release.
